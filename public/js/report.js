$(function(){
    ...
    $('.week a').on('click', e => {
        // e.preventDefault();
        const id = $(e.currentTarget).parent().attr('id'); //クリックされた日付文字列 2020-03-09 00:00:00
